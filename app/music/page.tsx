...
export default function MusicPage() {
    ...
    return (
        <div className="grid grid-cols-12 grid-rows-12 h-screen w-screen">
            <div className="col-start-1 col-end-2 row-start-1 row-end-13 p-4">
            ...
            <div className="col-start-2 col-end-13 row-start-1 row-end-3 p-2 border-l-1 border-gray-500">
            ...
            <div className="col-start-2 col-end-10 row-start-2 row-end-13 p-2 border-l-1 border-gray-500">
                <Table>
                    <TableHeader>
                        <TableRow>
